...
public class LiveRoom implements Parcelable {
    ...
    private String getCover(String cover){
        return "http://101.251.196.90:8000/SuperWeChatServerV2.0/downloadAvatar?name_or_hxid="+cover+"&avatarType=chatroom_icon&m_avatar_suffix=.jpg";
    }
}
